...
Terms
Class -a class is the design of an object. In the case of a Car a list of parts with functions
Generally called blueprint
                              or
class-a class is the blueprint of an object.The class stores data and function in a single  unit.

Object- Object is an Instance of a class. The actual produced car. Once a class is made we can create
unlimited objects.
